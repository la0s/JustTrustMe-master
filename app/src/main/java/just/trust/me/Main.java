    ...
    public void handleLoadPackage(final LoadPackageParam lpparam) throws Throwable {
        ...
        findAndHookMethod("javax.net.ssl.SSLContext", lpparam.classLoader, "init", KeyManager[].class, TrustManager[].class, SecureRandom.class, new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                Log.d(TAG, "Hooking javax.net.ssl.SSLContext.init for: " + currentPackageName);
        ...
        if (hasTrustManagerImpl()) {
            ...
            findAndHookMethod("com.android.org.conscrypt.TrustManagerImpl", lpparam.classLoader,
                    ...
                    new XC_MethodReplacement() {
                        @Override
                        protected Object replaceHookedMethod(MethodHookParam param) throws Throwable {
                            Log.d(TAG, "Hooking com.android.org.conscrypt.TrustManagerImpl.checkServerTrusted(X509Certificate[] chain, String authType) for: " + currentPackageName);
                            return 0;
                        }
                    });
            ...
            findAndHookMethod("com.android.org.conscrypt.TrustManagerImpl", lpparam.classLoader,
                    ...
                    String.class, new XC_MethodReplacement() {
                        @Override
                        protected Object replaceHookedMethod(MethodHookParam param) throws Throwable {
                            Log.d(TAG, "Hooking com.android.org.conscrypt.TrustManagerImpl.checkServerTrusted(X509Certificate[] chain, String authType, String host) for: " + currentPackageName);
            ...
            findAndHookMethod("com.android.org.conscrypt.TrustManagerImpl", lpparam.classLoader,
                    ...
                    SSLSession.class, new XC_MethodReplacement() {
                        @Override
                        protected Object replaceHookedMethod(MethodHookParam param) throws Throwable {
                            Log.d(TAG, "Hooking com.android.org.conscrypt.TrustManagerImpl.checkServerTrusted(X509Certificate[] chain, String authType, SSLSession session) for: " + currentPackageName);
                            ArrayList<X509Certificate> list = new ArrayList<X509Certificate>();
                            return list;
                        }
                    });
    ...
    private void processXutils(ClassLoader classLoader) {
        ...
        try {
            ...
            findAndHookMethod("org.xutils.http.RequestParams", classLoader, "setHostnameVerifier", HostnameVerifier.class, new XC_MethodHook() {
                @Override
                protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                    Log.d(TAG, "Hooking org.xutils.http.RequestParams.setHostnameVerifier for: " + currentPackageName);
                    super.beforeHookedMethod(param);
        ...
        try {
            ...
            findAndHookMethod("okhttp3.internal.tls.OkHostnameVerifier",
                    ...
                    new XC_MethodReplacement() {
                        @Override
                        protected Object replaceHookedMethod(MethodHookParam methodHookParam) throws Throwable {
                            Log.d(TAG, "Hooking okhttp3.internal.tls.OkHostnameVerifier.verify(String, SSLSession) for: " + currentPackageName);
                            return true;
                        }
                    });
        } catch (ClassNotFoundException e) {
        ...
        try {
            ...
            findAndHookMethod("okhttp3.internal.tls.OkHostnameVerifier",
                    ...
                    new XC_MethodReplacement() {
                        @Override
                        protected Object replaceHookedMethod(MethodHookParam methodHookParam) throws Throwable {
                            Log.d(TAG, "Hooking okhttp3.internal.tls.OkHostnameVerifier.verify(String, X509) for: " + currentPackageName);
                            return true;
                        }
                    });
        } catch (ClassNotFoundException e) {
